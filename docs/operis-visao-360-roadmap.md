...
**Doc técnico MVP:** [operis-cliente-360-mvp.md](./operis-cliente-360-mvp.md)  
**ADR:** [operis-visao-360-architecture.md](./adr/operis-visao-360-architecture.md)  
**Catálogo seed:** `operis/db/management/commands/operoz_visao_360_catalog.py`  
...
- Utils: `operis/utils/client_360.py`, `client_360_enterprise.py`
...
**Transição:** ADR [operis-visao-360-health-score-transition.md](./adr/operis-visao-360-health-score-transition.md) · flag workspace `health_score_display_enabled` · env `CLIENT_360_HEALTH_SCORE_DISPLAY_DEFAULT`.  
