# Operis — Plano de paridade total com Plane (sem cortes no escopo)
...
- [operis-plane-catalogo-completo-docs.md](./operis-plane-catalogo-completo-docs.md) — inventário por secção da sidebar
- [operis-workspace-mvp-plane.md](./operis-workspace-mvp-plane.md) — detalhe workspace
...
**Hierarquia Operis (mantida em paralelo ao Plane):** `Workspace → Board → Projeto (épico) → Card → Subtarefa`. Features Plane tipo Teamspace/Epic tornam-se **implementação compatível + UI alinhada ao Board**, não substituem o modelo.
...
| Plane AI (Pi Chat) + créditos                                                  | Incluído; pode coexistir com [MCP Operis](./operis-mcp.md)                    |
...
| MV3–MV6 Tech4Humans (Status Report, PRD, RBAC, Kortex)                         | **Em paralelo** — não são “extras”, fazem parte do produto Operis             |
...
F15 GAC + RBAC enterprise (permission schemes, custom roles) + MV5 Operis
...
| ---- | ------------------------------------------------------------------------------------------------------ | ------------------------- | --------------------------------------- |
| F0-1 | [operis-gap-tracker.md](./operis-gap-tracker.md) (~121 linhas)                                         | Estado código / Fase      | ✅ criado                               |
| F0-2 | [operis-f0-smoke-checklist.md](./operis-f0-smoke-checklist.md) + [resultado](./operis-f0-resultado.md) | Smoke manual A–D          | 🟡 API OK; UI pendente                  |
| F0-3 | Rotas board `/views`, tabs                                                                             | Paridade MVP-2            | 🟡 rotas **existem** — validar smoke B9 |
| F0-4 | [operis-f0-ce-stubs-inventory.md](./operis-f0-ce-stubs-inventory.md)                                   | 87 stubs em `apps/web/ce` | ✅                                      |
| F0-5 | [operis-f0-merge-upstream.md](./operis-f0-merge-upstream.md)                                           | Política merge            | ✅                                      |

---

## 5. Fase 1 — Gestão do espaço de trabalho (6–8 semanas)

**Referência:** [operis-workspace-mvp-plane.md](./operis-workspace-mvp-plane.md)
...
| ID   | Feature                         | Ação                                   |
| ---- | ------------------------------- | -------------------------------------- |
| F6-1 | Páginas projeto + editor blocks | `@operis/editor`                       |
...
| F7-7 | **Automations custom**          | [operis-automacao-mvp-spec](./operis-automacao-mvp-spec.md) estender |
...
| F13-4 | **Operis MCP** paridade ferramentas       | [operis-mcp.md](./operis-mcp.md) — todas as entidades |
...
| F15-6 | **MV5 Operis** papéis board/projeto | [roadmap MV5](./tech4humans-roadmap-mv3-mv5.md) integrado em GAC |
...
## 21. Fase 17 — Tech4Humans (produto Operis) (8–12 semanas)
...
| F18-3 | Documentação utilizador Operis (help center)                                              |
| F18-4 | Performance (search, board agregado, dashboards)                                          |
| F18-5 | Checklist paridade vs [catálogo](./operis-plane-catalogo-completo-docs.md) §16 — 13/13 ✅ |
...
| Track A (Produto Operis) | Track B (Paridade Plane)          |
| ------------------------ | --------------------------------- |
...
3. **Não pular F2** — Boards é o coração Operis; paridade Plane sem board hub deixa o produto incoerente.
4. Criar milestone no Git por fase (F0…F18).

Se quiseres, no próximo passo gero o ficheiro **`operis-gap-tracker.md`** com as ~120 linhas do catálogo, colunas **Fase | Estado código | Ticket | Responsável** — pronto para copiar para o Jira.
...
- **Duplicação consciente:** Teamspace + Board coexistem na paridade; a doc Operis explica qual usar.
