...
- [ ] 8 modelos + migração + data migration de scheme default.
- [ ] Engine com registries e testes unit por tipo.
- [ ] API com permissões e validação de consistência no publish.
- [ ] Designer reusa canvas React Flow (sem editor novo).
