# Planejamento — Arquitetura de Paridade Jira do Operoz

Esta pasta transforma o roadmap de alto nível
([operoz-jira-paridade-roadmap-completo.md](../operoz-jira-paridade-roadmap-completo.md))
...
aos padrões reais já existentes no codebase Operoz e com ênfase em
...
3. Cada documento é um ADR no formato interno do Operoz
...
| [02](./02-OQL-Query-Language/)          | **OQL (Operoz Query Language)**        | P0         | Sem linguagem de query tipo JQL                              |
