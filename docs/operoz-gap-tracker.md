# Operoz — Gap tracker (F0-1)

Rastreio paridade Plane × Operoz. Atualizar a cada sprint.
...
| `OPEROZ`  | Custom Tech4Humans (não copiar Plane literal) |
...
| P08 | Board → projetos  | ✅  | ✅   | OPEROZ    | F2   | Custom `board_id`     |
...
| I07 | Epic como tipo          | 🟡  | STUB | PARCIAL   | F3   | `epic-modal` stub; épico=Projeto OPEROZ |
...
| PL09 | Teamspaces            | ❌  | STUB | OPEROZ    | F4   | Stub; usar **Board**            |
...
| K02 | Editor blocks           | ✅  | ✅   | OK        | F6   | `@operoz/editor` |
...
| A06 | Automações custom        | ✅  | ✅   | IMPLEMENTADO | F7   | motor `operoz/automation/` + React Flow |
...
| C06 | Project updates      | ✅  | ✅   | OPEROZ    | F17  | Status report board |
...
| AI03 | Operoz MCP    | ✅  | N/A | OPEROZ    | F13  | `mcp-server/` |

---

## §14 Operoz-only (Tech4Humans)
...
| F0-2 Smoke          | [operoz-f0-smoke-checklist.md](./operoz-f0-smoke-checklist.md)       | ☐ executar |
| F0-3 Rotas board    | Rotas existem; **validar** smoke B9                                  | ☐          |
| F0-4 CE stubs       | [operoz-f0-ce-stubs-inventory.md](./operoz-f0-ce-stubs-inventory.md) | ✅         |
| F0-5 Merge upstream | [operoz-f0-merge-upstream.md](./operoz-f0-merge-upstream.md)         | ✅         |
