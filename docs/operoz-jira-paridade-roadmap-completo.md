# Operoz — Roadmap de Paridade Jira (Completo)

**Objetivo:** Documentar TODAS as funcionalidades do Jira Software / Jira Cloud / ecossistema Atlassian, comparar com o estado atual do Operoz, e definir um roadmap de implementação item a item.

| Campo      | Valor                                                                                                           |
| ---------- | --------------------------------------------------------------------------------------------------------------- |
| **Versão** | 1.0                                                                                                             |
| **Data**   | 2026-06-24                                                                                                      |
| **Autor**  | Gerado por análise automatizada do codebase Operoz + pesquisa Jira                                              |
...
| Símbolo | Significado                               |
| ------- | ----------------------------------------- |
| ✅      | Implementado no Operoz                    |
| 🟡      | Parcial / limitado                        |
| ❌      | Não existe no Operoz                      |
| 🔵      | Diferencial Operoz (sem equivalente Jira) |
...
| #     | Funcionalidade Jira                 | Descrição detalhada                                                                                                    | Operoz                  | Prioridade | Roadmap                                                                        |
| ----- | ----------------------------------- | ---------------------------------------------------------------------------------------------------------------------- | ----------------------- | ---------- | ------------------------------------------------------------------------------ |
...
| #    | Campo Jira                  | Descrição                                                                      | Operoz                                          | Prioridade | Roadmap                                                    |
| ---- | --------------------------- | ------------------------------------------------------------------------------ | ----------------------------------------------- | ---------- | ---------------------------------------------------------- |
...
| 3.3  | **Assignee**                | Responsável (1 pessoa)                                                         | ✅ `assignees` (múltiplos)                      | —          | Operoz já é melhor (multi-assignee)                        |
...
- Editor visual com React Flow (XYFlow já é dependência do Operoz)
...
| #     | Vista                                | Descrição                                                                        | Operoz                             | Prioridade | Roadmap                                             |
| ----- | ------------------------------------ | -------------------------------------------------------------------------------- | ---------------------------------- | ---------- | --------------------------------------------------- |
...
| #    | Funcionalidade Jira           | Descrição detalhada                                                                                                 | Operoz     | Prioridade | Roadmap                                                        |
| ---- | ----------------------------- | ------------------------------------------------------------------------------------------------------------------- | ---------- | ---------- | -------------------------------------------------------------- |
| 11.1 | **JQL (Jira Query Language)** | Linguagem tipo SQL: `project = PROJ AND status = "In Progress" AND assignee = currentUser() ORDER BY priority DESC` | ❌         | P0         | Fase 1 — **OQL (Operoz Query Language)** — ver detalhes abaixo |
...
### 11.10 Especificação OQL (Operoz Query Language)
...
| 21.2  | **Rich editor**           | WYSIWYG com tabelas, imagens, code blocks, embeds, macros                                   | ✅ @operoz/editor    | —          | —                                      |
...
| 21.14 | **Link to issues**        | Referenciar issues Operoz dentro das páginas, com status atualizado                         | 🟡                   | P2         | Fase 3 — Issue mention com live status |
...
| #     | Funcionalidade Jira         | Descrição detalhada                                       | Operoz                         | Prioridade | Roadmap                                                   |
| ----- | --------------------------- | --------------------------------------------------------- | ------------------------------ | ---------- | --------------------------------------------------------- |
| 22.1  | **Marketplace**             | Loja de 1000+ apps e integrações                          | ❌                             | P2         | Fase 5 — Galeria de Packs (já planeada no roadmap Operoz) |
...
| 26.2  | **Rovo**                        | Agentes IA que fazem ações: criar issues, atualizar campos, buscar info   | 🔵 Assistente + MCP | —          | Operoz já tem mais                          |
...
| 26.10 | **MCP server**                  | Protocolo para agentes externos acederem o Operoz                         | 🔵 676 operações    | —          | Implementado — diferencial                  |
...
| Categoria                | Total items | ✅ Operoz tem | 🟡 Parcial   | ❌ Falta      |
| ------------------------ | ----------- | ------------- | ------------ | ------------- |
...
## 29. Diferenciais Operoz (sem equivalente Jira)

O Operoz já tem features que o Jira **não oferece nativamente**:

| Feature Operoz                  | Descrição                                                                                         | Jira equivalente            |
| ------------------------------- | ------------------------------------------------------------------------------------------------- | --------------------------- |
...
**Conclusão estratégica:** O Operoz não precisa de copiar 100% do Jira. Precisa de fechar os gaps P0/P1 (Workflow, OQL, Time Tracking, Dashboards) mantendo e expandindo os diferenciais que o Jira nunca terá (Cliente 360, IA nativa, MCP, self-hosted).

---

_Documento de referência para roadmap de produto. Atualizar a cada sprint com progresso nas fases._
