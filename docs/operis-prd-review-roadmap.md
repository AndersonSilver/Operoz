...
**ADR:** [operis-prd-review-architecture.md](./adr/operis-prd-review-architecture.md)  
**Catálogo seed:** `operis/db/management/commands/operoz_prd_review_catalog.py`  
...
1. `operis_create_page` (ou equivalente) no projecto do cliente
2. Upload asset HTML (`PRD-*.html`) com manifesto `#operoz-prd-config`
3. `operis_update_page_description` — embed `html-document-embed` fullBleed
4. _(Fase 3)_ `operis_create_prd_review_session`
5. _(Fase 3)_ `operis_add_prd_review_invites` (e-mails stakeholders)
