...
| ID   | Item                                                                 | Status                            |
| ---- | -------------------------------------------------------------------- | --------------------------------- |
| F0-1 | [operis-gap-tracker.md](./operis-gap-tracker.md)                     | ✅                                |
| F0-2 | Smoke                                                                | ✅ Fechado — API + Playwright E2E |
| F0-3 | Rotas board                                                          | ✅ ficheiros existem; validar UI  |
| F0-4 | [operis-f0-ce-stubs-inventory.md](./operis-f0-ce-stubs-inventory.md) | ✅ 87 stubs                       |
| F0-5 | [operis-f0-merge-upstream.md](./operis-f0-merge-upstream.md)         | ✅                                |
...
| Workspace → board → projeto → issue               | **Coberto** em `test_operis_f0_smoke.py`                 |
...
5. **Uma onda fechada** — sem saltar fases do [plano completo](./operis-paridade-plane-plano-completo.md)
