# Operoz — Automação MVP — Especificação técnica

Documento de implementação derivado de [operoz-automacao-mvp-plano.md](./operoz-automacao-mvp-plano.md).  
...
**Permissão:** leitura/escrita exige `board.administer` ou workspace admin — reutilizar `allow_workspace_or_board_admin` de `operoz.app.permissions.board_access`.
...
| Área                   | Caminho                                                       |
| ---------------------- | ------------------------------------------------------------- |
| Plano produto          | `docs/operoz-automacao-mvp-plano.md`                          |
| Permissão board admin  | `apps/api/operoz/app/permissions/board_access.py`             |
| Board roles            | `apps/api/operoz/utils/board_roles.py`                        |
| Webhooks (padrão HTTP) | `apps/api/operoz/bgtasks/webhook_task.py`                     |
| IA workspace           | `apps/api/operoz/app/views/external/base.py`                  |
