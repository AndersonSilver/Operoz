...
| **Roadmap** | [operis-plataforma-violenta-roadmap.md](./operis-plataforma-violenta-roadmap.md) |
...
Refatorar `get_llm_config` para `operis/assistant/llm/`. OpenAI com tool-calling na Fase 0; Anthropic na mesma interface na Fase 0.4.
...
- [operis-assistant-security.md](./operis-assistant-security.md)
- Código: `apps/api/operis/assistant/`
