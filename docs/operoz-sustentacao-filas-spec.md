...
| **Relacionado** | [operoz-sustentacao-roadmap.md](./operoz-sustentacao-roadmap.md) |
...
Path: `apps/api/operoz/tests/unit/intake/`
...
| Área         | Path                                                                        |
| ------------ | --------------------------------------------------------------------------- |
| Model intake | `apps/api/operoz/db/models/intake.py`                                       |
| Model fila   | `apps/api/operoz/db/models/board_support_queue.py`                          |
| Utils        | `apps/api/operoz/utils/support_ticket.py`                                   |
| Serializer   | `apps/api/operoz/app/serializers/intake.py`                                 |
