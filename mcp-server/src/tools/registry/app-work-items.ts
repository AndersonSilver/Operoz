...
export const APP_WORK_ITEM_OPERATIONS = [
  ...
  op(
    ...
    "app",
    "GET",
    `/workspaces/{${ws}}/projects/{${proj}}/issues-detail/`,
    [ws, proj]
  ),
  op(
    "work_items",
    ...
    "app",
    "GET",
    `/workspaces/{${ws}}/projects/{${proj}}/v2/issues/`,
    [ws, proj]
  ),
  op(
    "work_items",
    ...
    "app",
    "GET",
    `/workspaces/{${ws}}/projects/{${proj}}/issues/{${pk}}/`,
    [ws, proj, pk]
  ),
  op(
    "work_items",
  ...
  op(
    ...
    "app",
    "GET",
    `/workspaces/{${ws}}/projects/{${proj}}/search-issues/`,
    [ws, proj]
  ),
  op(
    "work_items",
    ...
    "app",
    "DELETE",
    `/workspaces/{${ws}}/projects/{${proj}}/bulk-delete-issues/`,
    [ws, proj],
    {
      body: true,
    }
  ...
  op(
    ...
    "app",
    "POST",
    `/workspaces/{${ws}}/projects/{${proj}}/bulk-archive-issues/`,
    [ws, proj],
    {
      body: true,
    }
  ...
  op(
    ...
    "app",
    "GET",
    `/workspaces/{${ws}}/projects/{${proj}}/archived-issues/`,
    [ws, proj]
  ),
  op(
    "work_items",
    ...
    "app",
    "GET",
    `/workspaces/{${ws}}/projects/{${proj}}/deleted-issues/`,
    [ws, proj]
  ),
  op(
    "work_items",
    ...
    "app",
    "POST",
    `/workspaces/{${ws}}/projects/{${proj}}/issues/{${pk}}/archive/`,
    [ws, proj, pk],
    {
      body: true,
    }
  ...
  op(
    ...
    "app",
    "GET",
    `/workspaces/{${ws}}/projects/{${proj}}/issues/{${issue}}/meta/`,
    [ws, proj, issue]
  ),
  op(
    "work_items",
    ...
    "app",
    "GET",
    `/workspaces/{${ws}}/projects/{${proj}}/issues/{${issue}}/sub-issues/`,
    [ws, proj, issue]
  ),
  op(
    "work_items",
  ...
  op(
    ...
    "app",
    "GET",
    `/workspaces/{${ws}}/projects/{${proj}}/issues/{${issue}}/issue-links/`,
    [ws, proj, issue]
  ),
  op(
    "work_items",
  ...
  op(
    ...
    "app",
    "PATCH",
    `/workspaces/{${ws}}/projects/{${proj}}/issues/{${issue}}/issue-links/{${pk}}/`,
    [ws, proj, issue, pk],
    { body: true }
  ),
  op(
  ...
  op(
    ...
    "app",
    "GET",
    `/workspaces/{${ws}}/projects/{${proj}}/issues/{${issue}}/comments/`,
    [ws, proj, issue]
  ),
  op(
    "work_items",
  ...
  op(
    ...
    "app",
    "PATCH",
    `/workspaces/{${ws}}/projects/{${proj}}/issues/{${issue}}/comments/{${pk}}/`,
    [ws, proj, issue, pk],
    { body: true }
  ),
  op(
  ...
  op(
    ...
    "app",
    "GET",
    `/workspaces/{${ws}}/projects/{${proj}}/issues/{${issue}}/history/`,
    [ws, proj, issue]
  ),
  op(
    "work_items",
    ...
    "app",
    "GET",
    `/workspaces/{${ws}}/projects/{${proj}}/issues/{${issue}}/versions/`,
    [ws, proj, issue]
  ),
  op(
    "work_items",
    ...
    "app",
    "GET",
    `/workspaces/{${ws}}/projects/{${proj}}/issue-labels/`,
    [ws, proj]
  ),
  op(
    "work_items",
  ...
  op(
    ...
    "app",
    "POST",
    `/workspaces/{${ws}}/projects/{${proj}}/bulk-create-labels/`,
    [ws, proj],
    {
      body: true,
    }
  ...
  op(
    ...
    "app",
    "PATCH",
    `/workspaces/{${ws}}/projects/{${proj}}/intake-issues/{${pk}}/`,
    [ws, proj, pk],
    {
      body: true,
    }
  ...
  op(
    ...
    "app",
    "GET",
    `/workspaces/{${ws}}/projects/{${proj}}/inbox-issues/`,
    [ws, proj]
  ),
  op(
    "work_items",
  ...
  op(
    ...
    "app",
    "PATCH",
    `/workspaces/{${ws}}/projects/{${proj}}/inbox-issues/{${pk}}/`,
    [ws, proj, pk],
    {
      body: true,
    }
  ...
  op(
    ...
    "app",
    "GET",
    `/workspaces/{${ws}}/issues/{${issue}}/custom-fields/`,
    [ws, issue]
  ),
  op(
    "work_items",
