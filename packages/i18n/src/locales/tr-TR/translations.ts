export default {
  ...
  auth: {
    common: {
      ...
      new_to_operoz: "Operoz'e yeni mi geldiniz?",
  ...
  support: "Destek",
  forum: "Forum",
  powered_by_operoz_pages: "Operoz Pages tarafından desteklenmektedir",
  ...
  home: {
    empty: {
      ...
      create_project: {
        title: "Proje oluştur",
        description: "Çoğu şey Operoz'de bir projeyle başlar.",
        cta: "Başla",
      },
      invite_team: {
      ...
      personalize_account: {
        title: "Operoz'yi kendinize özelleştirin.",
  ...
  workspace_creation: {
    ...
    subheading: "Operoz'i kullanmaya başlamak için bir çalışma alanı oluşturmalı veya katılmalısınız.",
    form: {
      name: {
  ...
  workspace_dashboard: {
    empty_state: {
      general: {
        ...
        description:
          "Operoz'e hoş geldiniz, sizi aramızda görmekten heyecan duyuyoruz. İlk projenizi oluşturun ve iş öğelerinizi takip edin, bu sayfa ilerlemenize yardımcı olacak bir alana dönüşecek. Yöneticiler ayrıca ekiplerinin ilerlemesine yardımcı olacak öğeler görecek.",
        primary_button: {
          text: "İlk projenizi oluşturun",
          comic: {
            title: "Operoz'de her şey bir projeyle başlar",
            description:
  ...
  workspace_settings: {
    ...
    copy_key:
      "Bu gizli anahtarı Operoz Pages'e kopyalayıp kaydedin. Kapat düğmesine bastıktan sonra bu anahtarı göremezsiniz. Anahtar içeren bir CSV dosyası indirildi.",
    ...
    settings: {
      ...
      api_tokens: {
        ...
        delete: {
          ...
          description: "Bu token'ı kullanan uygulamalar artık Operoz verilerine erişemeyecek. Bu işlem geri alınamaz.",
          success: {
            title: "Başarılı!",
    ...
    empty_state: {
      api_tokens: {
        ...
        description: "Operoz API'lerini harici sistemlere entegre etmek için bir token oluşturun.",
      },
      webhooks: {
  ...
  profile: {
    ...
    empty_state: {
      activity: {
        ...
        description:
          "Yeni bir iş öğesi oluşturarak başlayın! Detaylar ve özellikler ekleyin. Aktivitenizi görmek için Operoz'de daha fazlasını keşfedin.",
      },
      assigned: {
  ...
  project_settings: {
    ...
    automations: {
      ...
      "auto-archive": {
        ...
        description: "Operoz, tamamlanan veya iptal edilen iş öğelerini otomatik arşivleyecek.",
        duration: "Şu süre kapalı kalan iş öğelerini otomatik arşivle",
      },
      "auto-close": {
        title: "İş öğelerini otomatik kapat",
        description: "Operoz, tamamlanmamış veya iptal edilmemiş iş öğelerini otomatik kapatacak.",
    ...
    empty_state: {
      no_issues: {
        ...
        primary_button: {
          ...
          comic: {
            title: "İş öğeleri Operoz'de yapı taşlarıdır.",
            description:
              "Operoz UI'yi yeniden tasarlamak, şirketi yeniden markalaştırmak veya yeni yakıt enjeksiyon sistemini başlatmak, muhtemelen alt iş öğeleri olan iş öğesi örnekleridir.",
          },
        },
      },
      no_archived_issues: {
  ...
  project_page: {
    empty_state: {
      general: {
        title:
          "Bir not, belge veya tam bir bilgi bankası yazın. Operoz'in AI asistanı Galileo'nun başlamanıza yardımcı olmasını sağlayın",
        description:
          "Sayfalar Operoz'de düşüncelerinizi döktüğünüz alanlardır. Toplantı notları alın, kolayca biçimlendirin, iş öğelerini yerleştirin, bir bileşen kitaplığı kullanarak düzenleyin ve hepsini proje bağlamınızda tutun. Herhangi bir belgeyi hızlıca tamamlamak için bir kısayol veya düğme ile Operoz'in AI'sı Galileo'yu çağırın.",
        primary_button: {
  ...
  self_hosted_maintenance_message: {
    operoz_didnt_start_up_this_could_be_because_one_or_more_operoz_services_failed_to_start:
      "Operoz başlatılamadı. Bu, bir veya daha fazla Operoz servisinin başlatılamaması nedeniyle olabilir.",
