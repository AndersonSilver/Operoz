    ...
    settings: {
      ...
      automation: {
        ...
        history: {
          ...
          empty: "No runs logged yet.",
          empty_hint: "Enable a rule and create or update issues, or use the test panel above.",
        ...
        ops: {
          metrics: {
            ...
            empty_description:
              "When active rules fire events, counters will show up here automatically.",
            groups: {
              dispatch: "Dispatcher",
              outbox: "Outbox",
              runs: "Runs",
            ...
            keys: {
              ...
              run_duration_ms: "Cumulative duration",
  ...
  workspace_settings: {
    ...
    settings: {
      general: {
        ...
        hero: {
          description:
            "Configure workspace identity, timezone, and preferences shared across your team.",
          highlights: {
        ...
        transfer_ownership: {
          ...
          section_description:
            "Make another member the workspace owner. You will remain an admin after the transfer.",
    ...
    features: {
      ...
      intake: {
        ...
        hero: {
          ...
          summary: "{forms, plural, one {# form} other {# forms}} · {published, plural, one {# published} other {# published}}",
  ...
  project_views: {
    detail: {
      ...
      work_items_count_tooltip:
        "{count, plural, one {# work item in this view} other {# work items in this view}}",
    },
    empty_state: {
      general: {
