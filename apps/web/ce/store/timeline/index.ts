...
import { BoardGroupedTimelineStore } from "@/store/timeline/board-grouped-timeline.store";
...
export interface ITimelineStore {
  ...
  groupedTimeLineStore: IBoardGroupedTimelineStore;
}
...
export class TimeLineStore implements ITimelineStore {
  ...
  constructor(rootStore: RootStore) {
    ...
    this.groupedTimeLineStore = new BoardGroupedTimelineStore(rootStore);
  }
}
