...
import type { IBoardIssuesFilter } from "./filter.store";

export interface IBoardIssues extends IBaseIssuesStore {
  // observable
  viewFlags: ViewFlags;
  // actions
  fetchIssues: (
...
export class BoardIssues extends BaseIssuesStore implements IBoardIssues {
  viewFlags = {
    enableQuickAdd: true,
  ...
  constructor(_rootStore: IIssueRootStore, issueFilterStore: IBoardIssuesFilter) {
