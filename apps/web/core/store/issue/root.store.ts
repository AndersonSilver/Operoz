...
import type { IBoardIssuesFilter } from "./board";
import { BoardIssuesFilter } from "./board";
import { BoardIssues } from "./board/issue.store";
...
export interface IIssueRootStore {
  ...
  boardIssuesFilter: IBoardIssuesFilter;
...
export class IssueRootStore implements IIssueRootStore {
  ...
  constructor(rootStore: RootStore, serviceType: TIssueServiceType = EIssueServiceType.ISSUES) {
    ...
    this.boardIssuesFilter = new BoardIssuesFilter(this);
    this.boardIssues = new BoardIssues(this, this.boardIssuesFilter);
