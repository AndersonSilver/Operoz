...
// operoz web imports
import { HomePeekOverviewsRoot } from "@/operoz-web/components/home";
import { TourRoot } from "@/operoz-web/components/onboarding/tour/root";
// local imports
  ...
  return (
    <>
      {currentUserProfile && !currentUserProfile.is_tour_completed && (
        <div className="fixed top-0 left-0 z-20 grid h-full w-full place-items-center overflow-y-auto bg-backdrop/80 p-4 backdrop-blur-sm transition-opacity">
