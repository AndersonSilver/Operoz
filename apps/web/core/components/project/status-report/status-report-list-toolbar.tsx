  ...
  return (
    <ProjectHubToolbar className="w-full max-w-full sm:w-auto">
      <ProjectHubToolbarSegment>
        ...
        <Tooltip
          tooltipContent={
            historySort === "desc" ? t("project.status_report.sort_newest") : t("project.status_report.sort_oldest")
          }
        >
          <IconButton
            variant="ghost"
            ...
            <Tooltip key={key} tooltipContent={t(labelKey)}>
              <button
                ...
                className={cn(
                  ...
                  listView === key && "shadow-sm bg-layer-transparent-active ring-1 ring-subtle/50 ring-inset"
                )}
      ...
      {canManage && onBatchExport ? (
        <>
          ...
          <ProjectHubToolbarSegment>
            ...
            >
              {batchExporting ? t("project.status_report.batch_exporting") : t("project.status_report.batch_export")}
            </button>
          </ProjectHubToolbarSegment>
        </>
      ) : null}
