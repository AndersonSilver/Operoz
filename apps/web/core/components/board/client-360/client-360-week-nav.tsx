...
export function Client360WeekNav({
  ...
  return (
    <div className={cn("flex flex-wrap justify-end gap-2 pr-2", className)}>
      <div className="flex items-stretch gap-2.5">
        ...
        {!isCurrentWeek ? (
          <button
            ...
            className="self-center rounded-lg px-2.5 py-1 text-11 font-medium text-secondary transition-colors hover:bg-layer-transparent-hover hover:text-primary"
          >
