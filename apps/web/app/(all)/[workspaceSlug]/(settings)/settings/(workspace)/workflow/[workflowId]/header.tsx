...
export const WorkflowEditorSettingsHeader = observer(function WorkflowEditorSettingsHeader(props: Props) {
      ...
      leftItem={
        <div className="flex items-center gap-2">
          <Breadcrumbs>
            ...
            />
            {workflowName ? <Breadcrumbs.Item component={<BreadcrumbLink label={workflowName} isLast />} /> : null}
          </Breadcrumbs>
        </div>
      }
    />
