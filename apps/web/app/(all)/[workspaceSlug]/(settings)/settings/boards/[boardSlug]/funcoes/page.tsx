...
import { BoardRolesSettings } from "@/components/settings/board/board-roles-settings";
...
const section = getBoardSettingsSection("roles")!;
...
function BoardRolesSettingsPage({ params }: Route.ComponentProps) {
  ...
  return (
    ...
    >
      ...
      <BoardRolesSettings workspaceSlug={workspaceSlug} boardSlug={boardSlug} boardName={board.name} />
    </SettingsContentWrapper>
  );
}

export default observer(BoardRolesSettingsPage);
