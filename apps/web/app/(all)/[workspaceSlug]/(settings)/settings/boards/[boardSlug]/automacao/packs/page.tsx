...
import { BoardAutomationPacksSettings } from "@/components/settings/board/board-automation-packs-settings";
...
const section = getBoardSettingsSection("automation_packs")!;
...
function BoardAutomationPacksPage({ params }: Route.ComponentProps) {
  ...
  return (
    ...
    >
      ...
      <BoardAutomationPacksSettings workspaceSlug={params.workspaceSlug} board={board} />
    </SettingsContentWrapper>
  );
}

export default observer(BoardAutomationPacksPage);
