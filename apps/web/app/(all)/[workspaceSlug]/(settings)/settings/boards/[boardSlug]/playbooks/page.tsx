...
import { BoardPlaybooksSettings } from "@/components/settings/board/board-playbooks-settings";
...
const section = getBoardSettingsSection("playbooks")!;
...
function BoardPlaybooksPage({ params }: Route.ComponentProps) {
  ...
  return (
    ...
    >
      ...
      <BoardPlaybooksSettings workspaceSlug={params.workspaceSlug} board={board} />
    </SettingsContentWrapper>
  );
}

export default observer(BoardPlaybooksPage);
