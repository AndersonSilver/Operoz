...
import { BoardAccessSettings } from "@/components/settings/board/board-access-settings";
...
const section = getBoardSettingsSection("access")!;
...
function BoardAccessSettingsPage({ params }: Route.ComponentProps) {
  ...
  return (
    ...
    >
      ...
      <BoardAccessSettings workspaceSlug={workspaceSlug} boardSlug={boardSlug} boardName={board.name} />
    </SettingsContentWrapper>
  );
}

export default observer(BoardAccessSettingsPage);
