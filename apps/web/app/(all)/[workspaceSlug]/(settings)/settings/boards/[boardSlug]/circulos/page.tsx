...
import { BoardCirclesSettings } from "@/components/settings/board/board-circles-settings";
...
const section = getBoardSettingsSection("circles")!;
...
function BoardCirclesSettingsPage({ params }: Route.ComponentProps) {
  ...
  return (
    ...
    >
      ...
      <BoardCirclesSettings workspaceSlug={workspaceSlug} boardSlug={boardSlug} boardName={board.name} />
    </SettingsContentWrapper>
  );
}

export default observer(BoardCirclesSettingsPage);
