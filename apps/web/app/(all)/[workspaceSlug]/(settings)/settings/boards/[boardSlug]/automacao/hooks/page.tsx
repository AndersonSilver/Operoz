...
import { BoardAutomationHooksSettings } from "@/components/settings/board/board-automation-hooks-settings";
...
const section = getBoardSettingsSection("automation_hooks")!;
...
function BoardAutomationHooksPage({ params }: Route.ComponentProps) {
  ...
  return (
    ...
    >
      ...
      <BoardAutomationHooksSettings workspaceSlug={params.workspaceSlug} board={board} />
    </SettingsContentWrapper>
  );
}

export default observer(BoardAutomationHooksPage);
