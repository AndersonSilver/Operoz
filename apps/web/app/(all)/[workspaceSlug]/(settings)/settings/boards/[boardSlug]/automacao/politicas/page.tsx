...
import { BoardAutomationPolicySettings } from "@/components/settings/board/board-automation-policy-settings";
...
const section = getBoardSettingsSection("automation_policy")!;
...
function BoardAutomationPolicyPage({ params }: Route.ComponentProps) {
  ...
  return (
    ...
    >
      ...
      <BoardAutomationPolicySettings workspaceSlug={params.workspaceSlug} board={board} />
    </SettingsContentWrapper>
  );
}

export default observer(BoardAutomationPolicyPage);
