...
import { BoardModuleStagesSettings } from "@/components/settings/board/board-module-stages-settings";
...
const section = getBoardSettingsSection("module_stages")!;
...
function BoardModuleStagesSettingsPage({ params }: Route.ComponentProps) {
  ...
  return (
    ...
    >
      ...
      <BoardModuleStagesSettings workspaceSlug={workspaceSlug} boardSlug={boardSlug} />
    </SettingsContentWrapper>
  );
}

export default observer(BoardModuleStagesSettingsPage);
