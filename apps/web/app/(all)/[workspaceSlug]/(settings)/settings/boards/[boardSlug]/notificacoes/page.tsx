...
import { BoardNotificationsSettings } from "@/components/settings/board/board-notifications-settings";
...
const section = getBoardSettingsSection("notifications_settings")!;
...
function BoardNotificationsSettingsPage({ params }: Route.ComponentProps) {
  ...
  return (
    ...
    >
      ...
      <BoardNotificationsSettings workspaceSlug={workspaceSlug} />
    </SettingsContentWrapper>
  );
}

export default observer(BoardNotificationsSettingsPage);
