...
import { BoardAutomationSettings } from "@/components/settings/board/board-automation-settings";
...
function BoardAutomationSettingsPage({ params }: Route.ComponentProps) {
  ...
  return (
    ...
    >
      ...
      <BoardAutomationSettings workspaceSlug={params.workspaceSlug} board={board} />
    </SettingsContentWrapper>
  );
}
