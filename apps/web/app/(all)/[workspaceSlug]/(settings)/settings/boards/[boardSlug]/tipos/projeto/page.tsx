...
const section = getBoardSettingsSection("project_schema")!;
...
function BoardProjectSchemaSettingsPage({ params }: Route.ComponentProps) {
...
export default observer(BoardProjectSchemaSettingsPage);
