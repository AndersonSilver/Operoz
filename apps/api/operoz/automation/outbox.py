...
from operoz.automation.governance import record_dispatch
from operoz.automation.observability import automation_log, record_metric
...
def schedule_automation_jobs(event: DomainEvent, rules) -> None:
    ...
    from operoz.db.models import BoardAutomationOutbox
    ...
    def flush() -> None:
        from operoz.bgtasks.automation_task import enqueue_automation_outbox
