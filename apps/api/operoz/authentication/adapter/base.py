...
from operoz.bgtasks.user_activation_email_task import user_activation_email
...
class Adapter:
    ...
    def __init__(self, request, provider, callback=None):
        ...
        self.user_data = None
        self.logger = logging.getLogger("operoz.authentication")
    ...
    def sync_user_data(self, user):
        ...
        from operoz.utils.user_display import display_name_from_identity
