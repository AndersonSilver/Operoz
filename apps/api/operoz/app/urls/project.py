...
from operoz.app.views.board.project_permissions import ProjectBoardPermissionsEndpoint
from operoz.app.views.project.status_reports import (
    ProjectStatusReportDetailEndpoint,
    ProjectStatusReportEndpoint,
    ProjectStatusReportExportEndpoint,
)
from operoz.app.views.project.status_report_preview import ProjectStatusReportPreviewEndpoint
