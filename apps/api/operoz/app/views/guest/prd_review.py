...
from operoz.db.models import PageReviewComment, PageReviewEvent, PageReviewSession
...
class PrdReviewGuestSubmitEndpoint(BaseAPIView):
    ...
    def post(self, request, token):
        ...
        from operoz.bgtasks.prd_review_submit_notify_task import prd_review_submit_notify
        ...
        if session.status == PageReviewSession.STATUS_CHANGES_REQUESTED:
            from operoz.automation.prd_review_hooks import emit_prd_review_feedback_submitted
