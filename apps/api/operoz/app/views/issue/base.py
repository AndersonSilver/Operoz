...
from operoz.app.serializers import (
...
from operoz.automation.hooks import (
...
from operoz.bgtasks.recent_visited_task import recent_visited_task
from operoz.bgtasks.webhook_task import model_activity
from operoz.bgtasks.alert_dispatch_task import dispatch_creation_alert, dispatch_issue_update_alerts
...
from operoz.utils.filters import ComplexFilterBackend, IssueFilterSet
from operoz.utils.global_paginator import paginate
from operoz.utils.grouper import (
    issue_group_values,
    issue_on_results,
...
from operoz.utils.order_queryset import order_issue_queryset
from operoz.utils.paginator import GroupedOffsetPaginator, SubGroupedOffsetPaginator
from operoz.utils.timezone_converter import user_timezone_converter
...
class IssueDetailEndpoint(BaseAPIView):
    ...
    def apply_annotations(self, issues):
        ...
        # issues-detail is only requested by Gantt — always prefetch dependency edges.
        return issues.prefetch_related(
            Prefetch(
                "issue_relation",
