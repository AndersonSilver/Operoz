...
# Module imports
from operoz.app.permissions import WorkspaceEntityPermission
from operoz.app.serializers import WorkspaceEstimateSerializer
from operoz.app.views.base import BaseAPIView
from operoz.db.models import Estimate, Project
