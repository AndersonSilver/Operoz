...
<code>operoz/assistant/service.py</code>,
<code>operoz/app/views/assistant/sessions.py</code>,
...
<code>Operoz/apps/api/operoz/tests/load/</code> ou repositório de QA.</p>""",
                "urgent",
            ),
            (
...
<code>operoz/tests/contract/app/test_assistant_app.py</code> ou equivalente.</p>""",
                "medium",
            ),
        ],
    ),
