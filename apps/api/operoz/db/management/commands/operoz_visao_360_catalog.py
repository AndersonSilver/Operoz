...
Ref: docs/operoz-visao-360-roadmap.md, docs/operoz-cliente-360-mvp.md
"""
...
<ul>
<li>Documento ADR em <code>Operoz/docs/adr/</code> cobrindo: modelo 1 projeto = 1 cliente vs entidade Client; health score 0–100 vs semáforo; agregação workspace vs board; estratégia de cache e read replica; extensibilidade PSA/CRM.</li>
...
<ul>
<li><code>Operoz/apps/web/core/components/workspace/client-360/workspace-client-360-list.tsx</code></li>
<li><code>Operoz/apps/web/core/components/board/client-360/*</code></li>
<li><code>Operoz/apps/api/operoz/app/views/workspace/client_360.py</code></li>
<li><code>Operoz/apps/api/operoz/utils/client_360.py</code></li>
<li><code>Operoz/docs/operoz-cliente-360-mvp.md</code></li>
<li><code>Operoz/docs/operoz-visao-360-roadmap.md</code></li>
</ul>""",
                "urgent",
            ),
            (
...
<p><strong>Contexto:</strong> Existe <code>operoz-visao-360-roadmap.md</code> inicial; o programa cresce para 70+ cards. Produto e engenharia precisam de fonte única sincronizada com catálogo seed e estado real da API/UI.</p>
<p><strong>Escopo técnico:</strong></p>
<ul>
<li>Actualizar <code>Operoz/docs/operoz-visao-360-roadmap.md</code> com tabela fase × módulo × API × rotas UI.</li>
<li>Secções: visão, personas, health actual vs alvo, FinOps, IA, enterprise, comandos seed/mark done.</li>
<li>Ligação cruzada com <code>operoz-cliente-360-mvp.md</code> e checklist go-live assistente se aplicável.</li>
...
<li>Doc operoz-visao-360-roadmap flags section.</li>
</ul>
<p><strong>Critérios de aceite:</strong></p>
<ul>
