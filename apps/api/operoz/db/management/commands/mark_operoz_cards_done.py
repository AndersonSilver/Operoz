...
from operoz.db.models import Issue, Module, Project, State, Workspace
from operoz.db.management.commands.seed_operoz_plataforma_violenta import (
    PROJECT_IDENTIFIER,
    prefixed_name,
    strip_prefix,
)
...
COMPLETED_CARD_TITLES: list[str] = [
    ...
    "- BUDGET VARIANCE CLIENTE VS OPEROZADO",
