"""Importa board Jira OPS para Operoz (projeto=cliente, modulo=epico, card=issue)."""
...
from operoz.utils.jira_ops import run_jira_ops_import


class Command(BaseCommand):
    help = "Import Jira OPS board into Operoz (client=project, epic=module)"
    ...
    def handle(self, *args: Any, **options: Any) -> None:
        ...
        self.stdout.write(f"Clientes: {result.clients}, modulos: {result.modules}, skip epics: {result.skipped_epics}")
