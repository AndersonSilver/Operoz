...
class ModuleGanttBarColorMode(models.TextChoices):
...
class Module(ProjectBaseModel):
    ...
    gantt_bar_color_mode = models.CharField(
        max_length=20,
        choices=ModuleGanttBarColorMode.choices,
        default=ModuleGanttBarColorMode.STATE,
    )
    gantt_bar_custom_color = models.CharField(max_length=7, blank=True, default="")
