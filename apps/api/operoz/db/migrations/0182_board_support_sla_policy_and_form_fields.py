...
import operoz.db.models.board_support_sla_policy
    ...
    for board in Board.objects.filter(deleted_at__isnull=True).iterator():
        BoardSupportSlaPolicy.objects.get_or_create(
            ...
            defaults={
                ...
                "policies": operoz.db.models.board_support_sla_policy.default_support_sla_policies(),
            },
        )
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("policies", models.JSONField(default=operoz.db.models.board_support_sla_policy.default_support_sla_policies)),
                (
                    "board",
