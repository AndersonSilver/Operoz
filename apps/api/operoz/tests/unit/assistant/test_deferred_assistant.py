...
from operoz.db.models import AssistantQualityDaily
from operoz.assistant.thread_summarization import (
    CONTEXT_SUMMARY_KEY,
    build_llm_history,
...
class TestDeferredAssistant:
    ...
    @patch("operoz.bgtasks.assistant_deferred_task.record_assistant_response_task")
    ...
    @override_settings(ASSISTANT_DEFER_NONCRITICAL="1")
    @patch("operoz.bgtasks.assistant_deferred_task.log_assistant_action_task")
    ...
    @patch("operoz.assistant.thread_summarization.summarize_message_batch", return_value="Resumo LLM async")
