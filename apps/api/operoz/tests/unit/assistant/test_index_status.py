...
from operoz.assistant.index_status import (
    mark_index_pending,
    persist_index_outcome,
    resolve_page_index_status,
)
from operoz.db.models import Page, Project, ProjectMember, SearchEmbedding, WorkspaceMember


@pytest.mark.unit
@pytest.mark.django_db
class TestIndexStatus:
    @patch("operoz.assistant.signals.schedule_entity_index")
    @patch("operoz.assistant.index_status.is_rag_enabled", return_value=True)
    @patch("operoz.assistant.index_status._load_status_record")
    @patch("operoz.assistant.index_status.is_index_debounce_active", return_value=True)
    @patch("operoz.assistant.index_status._redis_ttl", return_value=18)
    ...
    @patch("operoz.assistant.index_status.is_rag_enabled", return_value=True)
    @patch("operoz.assistant.index_status._compute_index_duration_seconds", return_value=75)
    @patch("operoz.assistant.index_status._load_status_record", return_value={"queued_at": "2026-06-11T12:00:00+00:00"})
    @patch("operoz.assistant.index_status._save_status_record")
    ...
    @patch("operoz.assistant.signals.schedule_entity_index")
    @patch("operoz.assistant.index_status.is_rag_enabled", return_value=False)
    ...
    @patch("operoz.assistant.index_status.is_rag_enabled", return_value=True)
    @patch("operoz.assistant.index_status._load_status_record")
    @patch("operoz.assistant.index_status.is_index_debounce_active", return_value=False)
    ...
    def test_stale_pending_record_still_shows_indexed(
        ...
        from operoz.assistant.index_status import compute_page_fingerprint
    ...
    @patch("operoz.assistant.signals.schedule_entity_index")
    @patch("operoz.assistant.index_status.is_rag_enabled", return_value=True)
    @patch("operoz.assistant.index_status._load_status_record", return_value=None)
    @patch("operoz.assistant.index_status.is_index_debounce_active", return_value=False)
    @patch("operoz.assistant.indexing_scheduler.index_entity_task")
    ...
    @patch("operoz.assistant.indexing_scheduler.ensure_page_index_queued")
    @patch("operoz.assistant.signals.schedule_entity_index")
    @patch("operoz.assistant.index_status.is_rag_enabled", return_value=True)
    @patch("operoz.assistant.index_status._load_status_record")
    @patch("operoz.assistant.index_status.is_index_debounce_active", return_value=False)
