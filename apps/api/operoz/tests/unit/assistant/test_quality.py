...
from operoz.assistant.quality import (
...
from operoz.db.models import AssistantQualityDaily, AssistantQualityReview
...
class TestAssistantQuality:
    ...
    @patch("operoz.assistant.quality.redis_instance")
