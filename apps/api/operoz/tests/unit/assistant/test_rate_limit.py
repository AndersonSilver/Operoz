...
from operoz.assistant.security.rate_limit import check_assistant_rate_limit, record_assistant_message


@pytest.mark.unit
class TestAssistantRateLimit:
    @patch("operoz.assistant.security.rate_limit._assistant_limits", return_value=(True, 2, 100))
    ...
    @patch("operoz.assistant.security.rate_limit._assistant_limits", return_value=(True, 60, 3))
    @patch("operoz.assistant.security.rate_limit.redis_instance")
