...
from operoz.assistant.chat_jobs import enqueue_chat_job, publish_job_event
from operoz.assistant.service import AssistantServiceError
from operoz.app.permissions import ROLE
from operoz.db.models import AssistantChatJob, AssistantSession, WorkspaceMember
...
class TestAssistantChatJobs:
    ...
    @patch("operoz.bgtasks.assistant_chat_task.run_assistant_chat_job_task")
    ...
    @patch("operoz.assistant.service.check_assistant_rate_limit", return_value=(False, "user_rate_limit", 30))
...
def test_publish_job_event_serializes_done_payload():
    with patch("operoz.assistant.chat_jobs.redis_instance") as mock_redis_factory:
        redis = MagicMock()
