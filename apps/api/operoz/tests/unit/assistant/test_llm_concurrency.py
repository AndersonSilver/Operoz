...
from operoz.assistant.llm.concurrency import (
...
from operoz.assistant.security.rate_limit import acquire_active_chat, check_assistant_rate_limit, release_active_chat


@pytest.mark.unit
class TestLlmSemaphore:
    @patch("operoz.assistant.llm.concurrency._cleanup_stale_holders")
    @patch("operoz.assistant.llm.concurrency.redis_instance")
    @patch("operoz.assistant.llm.concurrency._max_concurrent_llm", return_value=2)
    ...
    @patch("operoz.assistant.llm.concurrency._cleanup_stale_holders", return_value=1)
    @patch("operoz.assistant.llm.concurrency._max_concurrent_llm", return_value=40)
...
class TestConcurrentRateLimit:
    @patch("operoz.assistant.security.rate_limit._assistant_limits", return_value=(True, 60, 500))
    @patch("operoz.assistant.security.rate_limit._max_active_chats_per_user", return_value=1)
    @patch("operoz.assistant.security.rate_limit.redis_instance")
...
class TestKeyPool:
    ...
    @patch("operoz.assistant.llm.key_pool.is_key_open", return_value=False)
    ...
    @patch("operoz.assistant.llm.key_pool.redis_instance")
