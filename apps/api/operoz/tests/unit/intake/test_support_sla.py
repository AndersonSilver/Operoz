...
from operoz.utils.board_support_sla import compute_support_sla_breach
from operoz.utils.intake_submission import IntakeSubmissionError, _validate_submission_fields_from_list
...
@pytest.mark.unit
@patch("operoz.utils.support_ticket.get_criticality_duration_minutes", return_value=480)
...
@pytest.mark.unit
@patch("operoz.utils.support_ticket.get_board_support_sla_days", return_value=7)
