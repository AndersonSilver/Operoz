...
class TestSupportQueueValidation:
    ...
    @patch("operoz.utils.support_ticket.resolve_project_support_queue")
...
class TestAcceptWithoutBoardPromotion:
    def test_validate_allows_accept_without_default_state(self):
        from operoz.app.serializers.intake import IntakeIssueSerializer
        ...
        with patch("operoz.utils.support_ticket.resolve_project_support_queue") as mock_resolve:
            mock_resolve.return_value = Mock()
    ...
    def test_update_does_not_change_issue_state(self):
        ...
        with patch("operoz.app.serializers.intake.resolve_project_support_queue") as mock_resolve:
            mock_resolve.return_value = Mock()
