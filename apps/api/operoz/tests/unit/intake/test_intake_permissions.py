...
from operoz.utils.intake_permissions import (
...
class TestUserCanDeleteSupportTicket:
    ...
    @patch("operoz.utils.intake_permissions.user_is_workspace_admin", return_value=True)
    ...
    @patch("operoz.utils.intake_permissions.user_is_workspace_admin", return_value=False)
    ...
    @patch("operoz.utils.intake_permissions.user_is_workspace_admin", return_value=False)
    @patch("operoz.utils.intake_permissions.user_can_administer_board", return_value=False)
    @patch("operoz.utils.intake_permissions.get_effective_board_permission_keys", return_value=None)
    ...
    @patch("operoz.utils.intake_permissions.user_can_administer_board", return_value=False)
    @patch(
        "operoz.utils.intake_permissions.get_effective_board_permission_keys",
    ...
    @patch("operoz.utils.intake_permissions.user_is_workspace_admin", return_value=False)
    @patch("operoz.utils.intake_permissions.get_effective_board_permission_keys", return_value=None)
    @patch("operoz.utils.intake_permissions.user_can_administer_board", return_value=True)
    ...
    @patch("operoz.utils.intake_permissions.user_is_workspace_admin", return_value=False)
    @patch("operoz.utils.intake_permissions.user_can_administer_board", return_value=False)
    @patch("operoz.utils.intake_permissions.get_effective_board_permission_keys", return_value=set())
