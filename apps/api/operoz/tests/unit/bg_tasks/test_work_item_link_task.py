...
from operoz.bgtasks.work_item_link_task import safe_get, validate_url_ip
...
class TestValidateUrlIp:
    ...
    def test_rejects_private_ip(self):
        with patch("operoz.bgtasks.work_item_link_task.socket.getaddrinfo") as mock_dns:
...
class TestValidateUrlAllowlist:
    ...
    def test_allowlist_permits_private_ip(self):
        ...
        with patch("operoz.utils.ip_address.socket.getaddrinfo") as mock_dns:
...
class TestSafeGet:
    ...
    @patch("operoz.bgtasks.work_item_link_task.requests.get")
    @patch("operoz.bgtasks.work_item_link_task.validate_url_ip")
