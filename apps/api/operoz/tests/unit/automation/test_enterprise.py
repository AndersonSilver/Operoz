...
from operoz.automation.matching import extract_trigger_from_graph, rule_trigger_matches_event
from operoz.automation.secrets import redact_for_storage, resolve_config_value
from django.test import override_settings

from operoz.automation.governance import (
...
class TestSecrets:
    ...
    @patch("operoz.db.models.BoardAutomationSecret")
    @patch("operoz.automation.secrets.decrypt_data")
...
class TestGovernance:
    @patch("operoz.automation.governance.redis_instance")
