...
from operoz.automation.hooks_registry import HookExecutionContext, execute_hook_handler
...
class TestAutomationHooks:
    ...
    @patch("operoz.automation.hooks_registry.record_metric")
    def test_post_action_records_metric(self, mock_metric, workspace, workspace_board):
        ...
        from operoz.automation.hooks_registry import run_board_hooks
