...
@patch("operoz.rag.embeddings.get_llm_base_url", return_value=gemini_embedding_base_url())
@patch("operoz.rag.embeddings.get_configuration_value")
...
@patch("operoz.rag.embeddings.get_llm_base_url", return_value=None)
@patch("operoz.rag.embeddings.get_configuration_value")
...
@patch("operoz.rag.embeddings.create_openai_client")
@patch("operoz.rag.embeddings.get_embedding_config")
