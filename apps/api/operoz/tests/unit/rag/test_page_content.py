...
from operoz.db.models import Page, Project, ProjectMember, ProjectPage, SearchEmbedding, WorkspaceMember
...
class TestBuildPageIndexableText:
    @patch("operoz.rag.page_content.read_html_document_asset_text")
    ...
    @patch("operoz.rag.page_content.read_html_document_asset_text")
    @patch("operoz.rag.indexing.embed_texts")
    ...
    @patch("operoz.rag.page_content._read_storage_object_bytes")
