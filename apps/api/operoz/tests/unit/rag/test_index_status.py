...
from operoz.rag.index_status import (
    mark_index_pending,
...
class TestIndexStatus:
    @patch("operoz.rag.signals.schedule_entity_index")
    @patch("operoz.rag.index_status.is_rag_enabled", return_value=True)
    @patch("operoz.rag.index_status._load_status_record")
    @patch("operoz.rag.index_status.is_index_debounce_active", return_value=True)
    @patch("operoz.rag.index_status._redis_ttl", return_value=18)
    ...
    @patch("operoz.rag.index_status.is_rag_enabled", return_value=True)
    @patch("operoz.rag.index_status._compute_index_duration_seconds", return_value=75)
    @patch("operoz.rag.index_status._load_status_record", return_value={"queued_at": "2026-06-11T12:00:00+00:00"})
    @patch("operoz.rag.index_status._save_status_record")
    ...
    @patch("operoz.rag.signals.schedule_entity_index")
    @patch("operoz.rag.index_status.is_rag_enabled", return_value=False)
    ...
    @patch("operoz.rag.index_status.is_rag_enabled", return_value=True)
    @patch("operoz.rag.index_status._load_status_record")
    @patch("operoz.rag.index_status.is_index_debounce_active", return_value=False)
    ...
    def test_stale_pending_record_still_shows_indexed(
        ...
        from operoz.rag.index_status import compute_page_fingerprint
    ...
    @patch("operoz.rag.signals.schedule_entity_index")
    @patch("operoz.rag.index_status.is_rag_enabled", return_value=True)
    @patch("operoz.rag.index_status._load_status_record", return_value=None)
    @patch("operoz.rag.index_status.is_index_debounce_active", return_value=False)
    @patch("operoz.rag.indexing_scheduler.index_entity_task")
    ...
    @patch("operoz.rag.indexing_scheduler.ensure_page_index_queued")
    @patch("operoz.rag.signals.schedule_entity_index")
    @patch("operoz.rag.index_status.is_rag_enabled", return_value=True)
    @patch("operoz.rag.index_status._load_status_record")
    @patch("operoz.rag.index_status.is_index_debounce_active", return_value=False)
