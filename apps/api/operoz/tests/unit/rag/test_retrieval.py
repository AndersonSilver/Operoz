...
from operoz.rag.retrieval import (
...
class TestHybridRetrieval:
    @patch("operoz.rag.retrieval.embed_texts")
    @patch("operoz.rag.retrieval.embed_query_cached")
    def test_hybrid_retrieve_filters_cross_project(
        ...
        with patch("operoz.rag.indexing.embed_texts", return_value=[vec]):
