"""
F0 smoke automatizado — Operoz (workspace → board → projeto → issue + hub board).

Substitui o checklist manual em docs/operoz-f0-smoke-checklist.md para a camada API.
...
from operoz.db.models import Board, Issue, Project
