...
from operoz.assistant.embeddings import content_hash
from operoz.assistant.page_content import build_page_indexable_text
from operoz.assistant.retrieval import is_rag_enabled
...
def resolve_page_index_status(page: Page) -> dict[str, Any]:
    ...
    from operoz.assistant.indexing_scheduler import ensure_page_index_queued
