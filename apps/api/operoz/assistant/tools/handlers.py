...
from operoz.db.models import BoardAutomationRun, IntakeIssue
from operoz.db.models.intake import IntakeIssueStatus
from operoz.assistant.tools.registry import register_tool
from operoz.assistant.types import AssistantActorContext, ToolResult
from operoz.db.models import Page, PageReviewComment, PageReviewSession, ProjectPage
...
from operoz.utils.client_360_intelligence import build_suggested_actions, retrieve_client_360_history
from operoz.utils.client_360_operational import apply_operational_enrichment, load_board_support_sla_map
from operoz.utils.issue_search import search_issues
...
def handle_propose_automation_rule(ctx: AssistantActorContext, args: dict[str, Any]) -> ToolResult:
    from operoz.assistant.automation_intelligence import propose_automation_rule_from_nl
...
def handle_list_automation_packs(ctx: AssistantActorContext, args: dict[str, Any]) -> ToolResult:
    from operoz.automation.packs_registry import list_automation_packs
...
def handle_propose_automation_pack_install(ctx: AssistantActorContext, args: dict[str, Any]) -> ToolResult:
    from operoz.automation.packs_registry import get_automation_pack
    from operoz.db.models import BoardAutomationPackInstall
...
def handle_propose_issue_comment(ctx: AssistantActorContext, args: dict[str, Any]) -> ToolResult:
    from operoz.assistant.confirmed_actions import build_issue_comment_proposal
...
def handle_propose_issue_state_change(ctx: AssistantActorContext, args: dict[str, Any]) -> ToolResult:
    from operoz.assistant.confirmed_actions import build_issue_state_change_proposal
