...
from operis.db.models import AssistantSession, User, Workspace, WorkspaceMember
...
class Command(BaseCommand):
    ...
    def _run_sse_smoke(self, workspace_slug: str) -> tuple[bool, dict[str, Any]]:
        ...
        with patch("operis.app.views.assistant.sessions.iter_chat_events", side_effect=_mock_events):
            sync = client.post(
        ...
        with patch("operis.app.views.assistant.sessions.enqueue_chat_job_safe") as mock_enqueue:
