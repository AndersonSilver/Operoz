...
from operis.db.models import DEFAULT_STATES, Board, Module, ModuleIssue, Project, ProjectMember, State, User, Workspace
...
from operis.db.management.commands.operoz_chat_scaling_catalog import CHAT_SCALING_CATALOG
from operis.db.management.commands.operoz_prd_review_catalog import PRD_REVIEW_CATALOG
from operis.db.management.commands.operoz_visao_360_catalog import VISAO_360_CATALOG

PROJECT_NAME = "[ OPEROZ ] - DESENVOLVIMENTO DE PRODUTO"
PROJECT_IDENTIFIER = "OPEROZDP"
ROADMAP_DOC = "docs/operis-plataforma-violenta-roadmap.md"
NAME_PREFIX = "[ OPEROZ ]"
...
<p>Integrar tool-calling loop.</p>""",
            ...
            (
                ...
                """<p>Extrair de <code>app/views/external/base.py</code> para <code>operis/assistant/llm.py</code>.</p>
...
<p>Schema JSON para LLM: query, project_id, state, assignee.</p>""",
            ...
            (
                ...
                """<p><code>operis/assistant/tools/registry.py</code> — registo declarativo; reutilizar paths do mcp-server como referência.</p>""",
                "medium",
            ),
            (
    ...
    (
        ...
        [
            ...
            (
                ...
                """<p><code>operis/assistant/embeddings.py</code> — OpenAI text-embedding-3-small; batch.</p>""",
                "high",
            ),
            (
    ...
    (
        ...
        [
            (
                ...
                """<p><code>operis/automation/hooks_registry.py</code> — PreDispatch, PreAction, PostAction, OnFailure, OnComplete.</p>""",
                "high",
            ),
            (
