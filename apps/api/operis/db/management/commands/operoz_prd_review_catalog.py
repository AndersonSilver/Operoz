...
<ul>
<li>ADR em <code>Operis/docs/adr/</code>: sessão de review por <code>PageVersion</code>; identidade guest via convite; comentários section vs inline (quote + anchor).</li>
<li>Reutilizar padrão <code>Client360QbrGuestLink</code> para <code>PageReviewInvite</code>.</li>
<li>HTML embutido via <code>html-document-embed</code> + SDK JS desacoplado (<code>@operis/prd-review</code>).</li>
...
<p><strong>Escopo:</strong></p>
<ul>
<li>Criar <code>Operis/docs/operis-prd-review-roadmap.md</code> com fases 0–5, APIs, rotas guest e checklist MCP.</li>
...
<p><strong>Escopo:</strong></p>
<ul>
<li>Extrair tokens CSS T4H e layout de <code>{ROADMAP_REF}</code> para <code>Operis/templates/prd/</code>.</li>
