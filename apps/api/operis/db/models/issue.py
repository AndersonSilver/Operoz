...
from operis.db.mixins import SoftDeletionManager
from operis.utils.exception_logger import log_exception
from .project import ProjectBaseModel
from operis.utils.uuid import convert_uuid_to_integer
from .description import Description
from operis.db.mixins import ChangeTrackerMixin
...
class Issue(ProjectBaseModel):
    ...
    def save(self, *args, **kwargs):
        if self.state is None:
            try:
                from operis.db.models import State
