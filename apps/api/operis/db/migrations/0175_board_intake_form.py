import operis.db.models.board_intake_form
import uuid
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("anchor", models.CharField(db_index=True, default=operis.db.models.board_intake_form.get_board_intake_form_anchor, max_length=255, unique=True)),
                ("is_published", models.BooleanField(default=False)),
                ("fields", models.JSONField(default=operis.db.models.board_intake_form.default_board_intake_form_fields)),
