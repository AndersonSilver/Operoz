...
from operis.alerts.channels import get_channel_handler
from operis.alerts.preferences import (
    get_user_alert_preferences,
    is_alert_type_enabled_for_user,
    resolve_channels_for_rule,
)
from operis.alerts.quiet_hours import is_in_quiet_hours
from operis.alerts.recipients import resolve_recipients, resolve_support_recipients
from operis.alerts.throttle import rate_limit_check, throttle_check
from operis.alerts.types import AlertContext, AlertSubject
from operis.db.models import AlertLog, AlertRule
from operis.utils.host import frontend_base_url

if TYPE_CHECKING:
    from operis.db.models import IntakeIssue, Issue, User
