...
DEFAULT_RULES: list[dict] = [
    ...
    },
    {
        ...
        "channels": ["email", "in_app"],
        "config": {"notify_support_team": True, "notify_project_lead": True},
    },
    {
        "alert_type": AlertRule.AlertType.SUPPORT_TICKET_ACCEPTED,
        "name": "Ticket aceito",
        "channels": ["email", "in_app"],
        "config": {"notify_assignees": True, "notify_support_team": True},
    },
    {
        "alert_type": AlertRule.AlertType.SUPPORT_SLA_APPROACHING,
        "name": "SLA próximo do limite",
        "channels": ["email", "in_app"],
        "config": {"thresholds_minutes": [60, 15], "notify_assignees": True, "notify_support_team": True},
    },
    {
        "alert_type": AlertRule.AlertType.SUPPORT_SLA_BREACHED,
        "name": "SLA violado",
        "channels": ["email", "in_app", "discord_dm"],
        "config": {"notify_assignees": True, "notify_support_team": True, "notify_project_lead": True},
    },
    {
