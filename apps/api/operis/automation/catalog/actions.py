...
def _action_run_script(
    ...
    *,
    ...
    from operis.automation.policy import get_board_policy, script_runtime_limits, validate_script_source
...
def _action_operis_tool(
    ...
    *,
    ...
    from operis.db.models import Board, User, Workspace
