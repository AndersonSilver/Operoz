...
from operis.automation.catalog import catalog_for_board
...
from operis.automation.hooks_registry import HookExecutionContext, run_board_hooks
from operis.automation.executor_advanced import execute_fan_out, execute_retry_until
from operis.automation.policy import evaluate_pre_action_policy, policy_step_payload
...
def build_execution_context(event: DomainEvent, *, rule_id: str, automation_actor) -> dict[str, Any]:
    ...
    playbook_snippets = ""
    if event.board_id:
        from operis.playbooks.resolver import format_playbook_snippets, resolve_shared_board_playbooks
