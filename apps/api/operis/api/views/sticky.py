...
from operis.db.models import Sticky, Workspace
from operis.api.serializers import StickySerializer

# OpenAPI imports
from operis.utils.openapi.decorators import sticky_docs
