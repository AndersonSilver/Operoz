...
# Module imports
from operis.app.permissions.project import ProjectEntityPermission
from operis.api.views.base import BaseAPIView
from operis.db.models import Estimate, EstimatePoint, Project, Workspace
from operis.api.serializers import EstimateSerializer, EstimatePointSerializer
from operis.utils.openapi.decorators import estimate_docs, estimate_point_docs
