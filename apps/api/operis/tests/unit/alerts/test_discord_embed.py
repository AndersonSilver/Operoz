...
from operis.alerts.discord_embed import build_discord_alert_embed, build_discord_alert_message
...
def test_build_discord_alert_message_issue_created():
    ...
    assert embed["color"] == OPERIS_EMBED_COLOR_WARNING
...
def test_build_discord_alert_embed_due_date_overdue():
    ...
    assert embed["color"] == OPERIS_EMBED_COLOR_DANGER
