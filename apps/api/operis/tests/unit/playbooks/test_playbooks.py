...
from operis.assistant.indexing import build_playbook_chunks, split_markdown_sections
from operis.automation.domain import DomainEvent
from operis.automation.executor import build_execution_context
from operis.assistant.prompts import resolve_playbook_snippet
from operis.assistant.types import AssistantActorContext
from operis.db.models import BoardPlaybook, SearchEmbedding
...
class TestBoardPlaybookLifecycle:
    def test_publish_increments_version_and_indexes(self, workspace, workspace_board):
        ...
        with patch("operis.playbooks.lifecycle.index_playbook") as mock_index:
