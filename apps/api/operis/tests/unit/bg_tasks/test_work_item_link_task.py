...
from operis.bgtasks.work_item_link_task import safe_get, validate_url_ip
from operis.utils.ip_address import validate_url
...
class TestValidateUrlIp:
    ...
    def test_rejects_private_ip(self):
        with patch("operis.bgtasks.work_item_link_task.socket.getaddrinfo") as mock_dns:
...
class TestValidateUrlAllowlist:
    ...
    def test_allowlist_permits_private_ip(self):
        ...
        with patch("operis.utils.ip_address.socket.getaddrinfo") as mock_dns:
...
class TestSafeGet:
    ...
    @patch("operis.bgtasks.work_item_link_task.requests.get")
    @patch("operis.bgtasks.work_item_link_task.validate_url_ip")
