...
from operis.utils.intake_workflow import promote_issue_to_backlog, resolve_backlog_state


@pytest.mark.unit
class TestIntakeWorkflow:
    @patch("operis.utils.intake_workflow.State")
    ...
    @patch("operis.utils.intake_workflow.resolve_backlog_state")
