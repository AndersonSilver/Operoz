...
from operis.utils.jira_ops.import_service import resolve_module_status_for_module
...
def test_resolve_module_status_for_module_uses_issue_inference_when_jira_missing():
    ...
    with patch(
        "operis.utils.jira_ops.import_service.infer_module_status_from_linked_issues",
