...
from operis.automation.packs_lifecycle import install_automation_pack
from operis.db.models import BoardAutomationRule, BoardAutomationRun, BoardPlaybook, WorkspaceMember
from operis.playbooks.resolver import resolve_shared_board_playbooks
...
class TestChatAutomationTools:
    ...
    def test_explain_run_by_rule_name(self, create_user, workspace, workspace_board):
        ...
        with patch("operis.assistant.automation_intelligence.chat_completion") as mock_chat:
