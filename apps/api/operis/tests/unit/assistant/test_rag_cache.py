...
from operis.assistant.rag_cache import get_cached_rag_results, normalize_query, query_hash, store_rag_results
...
class TestRagCache:
    ...
    @patch("operis.assistant.rag_cache.cache")
...
class TestQueryEmbeddingCache:
    ...
    def test_embed_query_uses_short_ttl_prefix(self, mock_cache, mock_embed, _config):
        ...
        assert key_used.startswith("assistant:rag:query-embedding:")
