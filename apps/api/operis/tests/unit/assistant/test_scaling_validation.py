...
from operis.assistant.service import iter_chat_events
from operis.db.models import AssistantSession, User, WorkspaceMember
...
class TestScalingValidation:
    ...
    @patch("operis.assistant.service.stream_chat_completion", side_effect=_thread_safe_stream_side_effect)
