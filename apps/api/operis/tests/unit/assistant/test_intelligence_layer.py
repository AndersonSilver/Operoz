...
from operis.assistant.agent_orchestrator import decompose_complex_query, orchestrator_enabled
from operis.assistant.embedding_cache import embed_texts_cached
from operis.assistant.thread_summarization import build_llm_history, summarize_message_batch
from operis.assistant.tool_router import AUTOMATION_TOOLS, METRICS_TOOLS, READ_TOOLS, build_tool_route_plan
from operis.assistant.tools import handlers as _tool_handlers  # noqa: F401
from operis.assistant.tools.registry import list_openai_tools
...
class TestEmbeddingCache:
    @patch("operis.assistant.embedding_cache.get_embedding_config", return_value=("key", "text-embedding-3-small"))
    @patch("operis.assistant.embedding_cache._embed_texts_uncached")
    @patch("operis.assistant.embedding_cache.cache")
    def test_cache_hit_skips_api(self, mock_cache, mock_embed, _config):
