...
from operis.db.models import BoardAutomationRule, BoardAutomationRun


@pytest.mark.unit
class TestAutomationIntelligence:
    @patch("operis.assistant.automation_intelligence.llm_json_completion")
    ...
    @patch("operis.assistant.automation_intelligence.chat_completion")
