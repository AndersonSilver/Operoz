...
from operis.assistant.retrieval import hybrid_retrieve
from operis.assistant.security.sanitize import sanitize_assistant_content
from operis.assistant.tools.registry import execute_tool
from operis.assistant.types import AssistantActorContext
from operis.assistant.usage import get_usage_summary, record_assistant_usage
...
class TestCrossWorkspaceIsolation:
    ...
    @patch("operis.assistant.retrieval.embed_texts", return_value=[[0.0] * 1536])
    def test_rag_does_not_leak_other_workspace_embeddings(self, _mock_embed, create_user):
        ...
        with patch("operis.assistant.indexing.embed_texts", return_value=[[0.5] * 1536]):
...
class TestConfirmedActions:
    def test_propose_issue_comment(self, create_user, workspace, workspace_board):
        from operis.assistant.tools import handlers as _handlers  # noqa: F401
