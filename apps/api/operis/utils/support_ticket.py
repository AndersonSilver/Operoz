...
from operis.utils.board_support_sla import (
    compute_sla_due_at,
    compute_support_sla_breach,
    get_criticality_duration_minutes,
    parse_iso_datetime,
)
from operis.utils.support_criticality import criticality_label, is_valid_criticality
from operis.utils.html_processor import strip_tags

if TYPE_CHECKING:
    from operis.db.models import BoardIntakeForm, IntakeForm, IntakeIssue, Project
...
def resolve_project_support_queue(*, project: Project, queue_id: str | None):
    from operis.db.models import BoardSupportQueue
