...
from operis.assistant.indexing import IndexChunk, index_entity
from operis.db.models import Client360HealthSnapshot, Project, SearchEmbedding
from operis.utils.client_360_intelligence import build_snapshot_summary_text
