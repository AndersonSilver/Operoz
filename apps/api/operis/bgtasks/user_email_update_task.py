...
def send_email_update_confirmation(email):
    ...
    try:
        ...
        subject = "Endereço de e-mail Tech4Humans atualizado com sucesso"
        context = {"email": email}
        ...
        msg.attach_alternative(html_content, "text/html")
        msg.send()
        logging.getLogger("operis.worker").info(f"Email update confirmation sent successfully to {email}.")
        return
    except Exception as e:
        log_exception(e)
        return
