...
from operis.alerts.email_renderer import build_alert_email_context, send_alert_email_sync
...
def send_alert_email(
    *,
    ...
    issue = Issue.objects.select_related("project", "workspace").filter(pk=issue_id, deleted_at__isnull=True).first()
