...
from operis.assistant.index_status import DEBOUNCE_SECONDS, mark_index_pending
from operis.bgtasks.assistant_index_task import index_entity_task
...
def ensure_page_index_queued(page) -> bool:
    ...
    from operis.assistant.index_status import is_index_debounce_active
    from operis.assistant.page_content import build_page_indexable_text
    from operis.db.models import SearchEmbedding
