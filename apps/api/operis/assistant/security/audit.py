...
from operis.db.models import AssistantActionAudit, AssistantSession, Workspace
from operis.db.models.user import User
...
def log_assistant_action(
    *,
    ...
    if _defer_enabled():
        from operis.bgtasks.assistant_deferred_task import log_assistant_action_task
