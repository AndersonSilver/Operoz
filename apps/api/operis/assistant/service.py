...
from operis.assistant.agent_orchestrator import decompose_complex_query, format_orchestration_block
from operis.assistant.llm.client import parse_tool_arguments, stream_chat_completion
from operis.assistant.prompts import build_system_prompt
from operis.assistant.retrieval import build_rag_context_block, hybrid_retrieve
from operis.assistant.security.audit import log_assistant_action
from operis.assistant.security.confirmation import is_proposal_tool, proposal_metadata_key
from operis.assistant.security.sanitize import sanitize_assistant_content
from operis.assistant.thread_summarization import build_llm_history, schedule_session_summarization
from operis.assistant.tool_router import build_tool_route_plan
from operis.assistant.quality import record_assistant_response
from operis.assistant.observability import record_chat_outcome
from operis.assistant.usage import estimate_tokens, get_usage_summary, record_assistant_usage
from operis.db.models import AssistantActionAudit
from operis.assistant.security.access import require_workspace_member
from operis.assistant.llm.concurrency import release_llm_slot, try_acquire_llm_slot
from operis.assistant.security.rate_limit import (
    _assistant_limits,
    acquire_active_chat,
...
def _iter_chat_events_body(
    ...
    *,
    ...
    from operis.app.serializers.assistant import AssistantMessageSerializer, AssistantSessionSerializer
...
def confirm_assistant_action(session: AssistantSession, proposal: dict) -> dict:
    from operis.assistant.confirmed_actions import execute_confirmed_action
    from operis.assistant.security.confirmation import EXECUTABLE_CONFIRMED_ACTIONS
