...
from operis.app.permissions.page_review import PageReviewPermission
from operis.app.views.base import BaseAPIView
from operis.db.models import Issue, PageReviewComment, PageReviewEvent, PageReviewInvite, PageReviewSession, PageVersion
...
from operis.utils.page_review_sync import sync_review_comments_to_issue, user_can_sync_review
from operis.utils.page_review_export import export_review_session_pdf, safe_export_filename
...
class PageReviewInviteCreateEndpoint(BaseAPIView):
    ...
    def post(self, request, slug, project_id, page_id, session_id):
        ...
        if send_email is not False:
            from operis.bgtasks.prd_review_invite_task import prd_review_invite_email
