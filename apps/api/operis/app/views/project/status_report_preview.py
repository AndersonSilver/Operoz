...
from operis.app.serializers.board_status_report import ProjectStatusReportPreviewSerializer
from operis.app.views.base import BaseAPIView
from operis.db.models import BoardStatusReport, Project
from operis.utils.board_status_report import apply_live_entregas_from_module, default_report_title
