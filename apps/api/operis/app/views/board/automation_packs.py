...
from operis.app.serializers.board_automation_pack import BoardAutomationPackInstallSerializer
...
from operis.automation.packs_registry import get_automation_pack, list_automation_packs
