...
from operis.app.serializers.board_automation import BoardAutomationRuleSerializer
from operis.app.views.base import BaseAPIView
from operis.app.views.board.automation import _get_board, _lifecycle_error_response
