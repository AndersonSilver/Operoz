...
from operis.app.serializers import IssueSubscriberSerializer, ProjectMemberLiteSerializer
from operis.app.permissions import ProjectEntityPermission, ProjectLitePermission
from operis.db.models import IssueSubscriber, ProjectMember
