...
from operis.app.serializers import LabelSerializer
from operis.app.permissions import allow_permission, ProjectBasePermission, ROLE
from operis.db.models import Project, Label
