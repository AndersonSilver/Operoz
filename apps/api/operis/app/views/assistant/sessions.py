...
from operis.app.serializers.assistant import (
...
from operis.db.models import AssistantChatJob, AssistantMessage, AssistantQualityReview, AssistantSession, Workspace
from operis.app.views.base import BaseAPIView
from operis.assistant.chat_jobs import enqueue_chat_job_safe, iter_job_events, new_client_message_id
from operis.assistant.service import AssistantServiceError, confirm_assistant_action, iter_chat_events, run_chat
from operis.assistant.quality import get_assistant_quality_dashboard
...
class AssistantMessageFeedbackEndpoint(BaseAPIView):
    ...
    def patch(self, request, slug, session_id, message_id):
        ...
        from operis.assistant.quality import adjust_feedback_daily
