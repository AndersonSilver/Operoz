...
from operis.app.serializers.client_360_intelligence import (
...
from operis.utils.client_360_qbr_service import build_client_qbr_context
...
class WorkspaceClient360IntelligenceRagReindexEndpoint(BaseAPIView):
    @allow_permission(allowed_roles=[ROLE.ADMIN], level="WORKSPACE")
    def post(self, request, slug):
        from operis.utils.client_360_intelligence_rag import reindex_workspace_snapshots
