...
# Module imports
from operis.app.permissions import WorkspaceEntityPermission
from operis.app.serializers import WorkspaceEstimateSerializer
from operis.app.views.base import BaseAPIView
from operis.db.models import Estimate, Project
from operis.utils.cache import cache_response
