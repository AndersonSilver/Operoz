...
from plane.app.serializers.board_role import (
    BoardRoleSerializer,
...
from plane.db.models import Board, BoardRole, BoardRolePermission
from plane.utils.board_roles import BOARD_PERMISSION_KEYS_V1, seed_board_roles
