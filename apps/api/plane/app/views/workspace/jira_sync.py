...
from plane.bgtasks.jira_ops_sync_task import get_sync_status, start_jira_ops_sync
from plane.db.models import Workspace
from plane.utils.jira_ops import JiraOpsClient, preview_jira_ops_import
from plane.utils.jira_ops.workspace_config import (
    config_to_api_dict,
...
class WorkspaceJiraOpsSyncPreviewEndpoint(BaseAPIView):
    """Pré-visualização do que será criado/atualizado no Operis (somente admin)."""
